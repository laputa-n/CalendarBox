...
<details>
  <summary>(상단) 일정/친구/캘린더 요약 + (중앙) 통합 캘린더 + (우측) 중요 일정 정보 + (좌측) 네비게이터 제공</summary>
...
<details>
  <summary><b>장소 검색</b>으로 편리한 일정 장소 등록 및 장소 순서 변경 가능</summary>
...
<details>
  <summary>다양한 <b>참가자</b> 추가 모드</summary>
...
<details>
  <summary>일정별 <b>지출 관리</b> 기능</summary>
...
<details>
  <summary>그 외 다양한 일정 하위 리소스 기능(투두, 리마인더, 링크)</summary>
...
<details>
  <summary>일정 관리 탭에서 캘린더별 <b>일정 목록 조회</b> 가능 & 일정 <b>검색</b> 가능 & 일정 초대 <b>수락/거절</b> 가능</summary>
...
❤️**마강현 - Frontend / Design**

---

## 확장성

공개 그룹(오픈 그룹) 기능: 그룹 생성 → 가입 신청/승인 → 그룹 내 활동으로 확장 가능 (예: 오픈채팅)

공개 모임/일정 기능: 일정 게시 → 검색/조회 → 참가 신청/확정 → 후기/활동 기록으로 확장 가능 (예: 당근 모임)
